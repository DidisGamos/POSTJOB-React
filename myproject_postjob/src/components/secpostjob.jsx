...
const BodyPostJob=()=>{
    return(
        <div className="flex flex-col items-center">
            <h1 className="text-8xl text-[rgba(107,227,83)]">Win your dream job</h1>
            <h1 className="text-8xl text-white">with PostJob</h1>
            <div className="w-4/12 text-[rgba(97,98,97,255)] mt-5 text-center">
